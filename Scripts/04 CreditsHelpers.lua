...
local stepmania_credits= {
	{
		name= "StepMania 5 Original Staff",
		"",
	},
	{
	...
	{
		name= "StepMania Tacvicom Edition Staff",
		"",
	},
	{
		name= "All Editions and Modifications",
	...
	},
	{
		...
		"Jonathan Payne",
		"(Midiman)",
		"for the Legacy theme",
		"(Default for StepMania 5.0)",
		"",
		"Tacvicom Gaming Network",
		"Alfonsina Dmitria Simonovitch",
		"Danny Boy",
		"Kyzentun Keeslala",
		"MadkaT",
		"for helping me in some details to make this Theme",
	},
	{
		name= "PLEASE KEEP PRAYING FOR VENEZUELA!!!",
		"",
	},
}
