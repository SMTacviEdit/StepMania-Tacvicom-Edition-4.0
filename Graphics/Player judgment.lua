...
local jmLabel=ThemePrefs.Get("JudgmentLabel");
local judType;
if jmLabel then
	if jmLabel=="D3NEX" then
		judType="D3NEX";
	elseif jmLabel=="DDR" then
		judType="DDR";
	elseif jmLabel=="ITG" then
		judType="ITG";
	elseif jmLabel=="PIU" then
		judType="PIU";
	elseif jmLabel=="Starter" then
		judType="Starter";
	elseif jmLabel=="CS" then
		judType="CS";
	elseif jmLabel=="SM5" then
		judType="SM5";
	else
		judType="SMTE";
	end
