...
t[#t+1] = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		...
		OnCommand=cmd(shadowlength,2;diffuse,color("0.75,0.75,0.75,1");strokecolor,Color("White");zoom,0.5);
	};
	LoadFont("Common Normal") .. {
		Name="BpmText",
		InitCommand=cmd(x,4;horizalign,left;maxwidth,220);
		OnCommand=cmd(shadowlength,2;diffuse,color("0.75,0.75,0.75,1");strokecolor,Color("White");zoom,0.5);
	};
	LoadFont("Common Normal") .. {
		Text="TIME : ";
	...
	LoadFont("Common Normal") .. {
		Name="TimeText",
		InitCommand=cmd(x,170;horizalign,left;maxwidth,220);
		OnCommand=cmd(shadowlength,2;diffuse,color("0.75,0.75,0.75,1");strokecolor,Color("White");zoom,0.5);
	};
